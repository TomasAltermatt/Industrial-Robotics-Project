function [mass_matrix] = mass_matrix(m_pl, J_pl, J_rob, m_rob)
    ...
    J_tot = J_pl + J1 + J2 + J3 + Jbase;
    
    % Simplified Case
    mass_matrix = diag([m_pl, m_pl, m_pl, J_pl(3,3) + J3(3,3), m1, m1, m1, J1(3,3), m2, m2, m2, J2(3,3), m3, m3, m3, J_tot(2,2)]);
    %mass_matrix = diag([m_pl, m_pl, m_pl, J_pl(2,2) + J3(2,2), m1, m1, m1, J1(2,2), m2, m2, m2, J2(2,2), m3, m3, m3, J_tot(3,3)]);
