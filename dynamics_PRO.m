...
I1_prod = [I1_tot(2,3), I1_tot(1,3), I1_tot(1,2)];
...
I2_prod = [I2_tot(2,3), I2_tot(1,3), I2_tot(1,2)];
...
I3_prod = [I3_tot(2,3), I3_tot(1,3), I3_tot(1,2)];
...
for i = 1:length(time_vect)
    ...
    % Extended Jacobians
    Je = PROjacdinV2(Q, L, 0);
    Jep = PROjacPdinV2(Q, Qp, L, 0);
    Spp = Jep*Qp + Je*Qpp;
